...
python .\node_distances.py --e NodeDistances13 --d 3 --b 250 --y 1000
...
python .\node_distances.py --e NodeDistances94 --d 3 --b 250 --y 30000
python .\node_distances.py --e NodeDistances94 --d 3 --b 500 --y 15000
python .\node_distances.py --e NodeDistances94 --d 3 --b 1000 --y 30000
