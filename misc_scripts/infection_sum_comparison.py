...
def infection_sum_comparison(experiment_names:list[str], 
    ...
    for exp in experiment_names:
        ...
        if label_list:
            df[label_list[experiment_names.index(exp)]] = _df["Infection Sum"]
        else:
    ...
    if label_list: fig_path = dir_path / f"infection_sum_comparison{label_list}"
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--t', metavar="T", type=str, default = 'Comparison of Cumulative Infected Population', help='Figure Title')
