...
popular_times_v2 = None
if 'popular_times_v2_plugin' in lodus_simulation.experiment_config:
    popular_times_v2 = PopularTimesV2Plugin()
    lodus_simulation.load_plugin(popular_times_v2)
